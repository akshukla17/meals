...
class _TabsScreenState extends ConsumerState<TabsScreen> {
  ...
  Widget build(BuildContext context) {
    // watch is providing updated list if any change happen in data.
    //it will re-run if any change happen in data
    ref.read(filtersProvider); //getting from filterProvider
